        ...
        <div className="page" style={{ maxWidth: 1200, margin: '0 auto' }}>
            <div className="page-header flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-10 pb-6 border-b border-border-glass">
                <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                    <div style={{ width: 48, height: 48, borderRadius: 'var(--r-lg)', background: 'linear-gradient(135deg, rgba(212,160,23,0.2) 0%, rgba(0,201,255,0.2) 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(212,160,23,0.3)', boxShadow: '0 0 20px rgba(212,160,23,0.1)' }}>
                        <LayoutTemplate size={24} color="#D4A017" />
                    </div>
                    <div>
                        <h1 className="page-title" style={{ margin: 0, fontSize: '1.75rem', backgroundImage: 'linear-gradient(90deg, var(--text-primary), var(--text-secondary))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>My Templates</h1>
                        <p className="page-sub" style={{ margin: '4px 0 0 0', opacity: 0.8 }}>Certificate templates you have created</p>
                    </div>
                </div>
                <Link href="/teacher/templates/create" className="btn btn--primary w-full sm:w-auto justify-center" style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 20px', fontSize: '0.9375rem', fontWeight: 600, boxShadow: '0 8px 16px rgba(0, 201, 255, 0.25)', transition: 'transform 0.2s, box-shadow 0.2s' }}>
            ...
            {templates.length === 0 ? (
                <EmptyState
                    ...
                    subtitle="Create your first beautiful certificate template."
                />
            ) : (
