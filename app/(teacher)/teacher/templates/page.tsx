    ...
    return (
        <div className="page" style={{ maxWidth: 1200, margin: '0 auto' }}>
            <div className="page-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 40, borderBottom: '1px solid var(--border-glass)', paddingBottom: 24 }}>
                ...
                <Link href="/teacher/templates/create" className="btn btn--primary" style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 20px', fontSize: '0.9375rem', fontWeight: 600, boxShadow: '0 8px 16px rgba(0, 201, 255, 0.25)', transition: 'transform 0.2s, box-shadow 0.2s' }}>
